...
def _get_individual_yield(all_sold_stock_list, save_dir, reference='수익률', ascending=False):
    """
...
def _analyze_results(**result_params):
    ...
    _get_individual_yield(all_sold_stock_list, save_dir=strategy_dir, reference='수익률', ascending=False)